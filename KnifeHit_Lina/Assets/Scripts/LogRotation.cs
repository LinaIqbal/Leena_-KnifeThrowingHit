...
public class LogRotation : MonoBehaviour {
    ...
    private class RotationElement
    {
        ...
        #pragma warning restore 0649 // after fields are sorted it enables it again
    }

// SerializeField will let us modify the values in the editor when the game is running
    ...
    private void Awake() // Called only once.
    {
        ...
        StartCoroutine("PlayRotationPattern"); // to execute a piece of code across multiple frames. 
    }

    private IEnumerator PlayRotationPattern() // to fetch current element
    {
        int rotationIndex = 0;
